...
My time at Bluestamp has taught me many things. For example, I learned soldering skills, coding skills, essential assembly skills, screwing, cadding, and battery knowledge. When I first started soldering I was really scared because the soldering iron was 400 degrees celcius. I overcame this fear by soldering over and over again. I learned lots of coding through processing, ardino, and python. I learned that the servos in my hexapod turn on and off and on and off to make it move like it does. I tinkercadded a head and a battery pack which took time to get the mesurements right but in the end it look super cool. I learned how to screw from small to big things. The smaller ones were the hardest but were the best in the end. I didnt know that hot glue on motors would break them and that weight on top is a big thing in engineering. Overall, my time at bluestamp has taught me many essential engineering skills and I had lost of fun experiences at bluestamp.
